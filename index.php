...
<div class="textabout" id="allimages"> 
	<img alt="!" id="past" class="past" src="images/past.png">

	<a href="#right"><img alt="!" id="now" class="now" src="images/now.png"></a>
</div> 

<!--<img alt="!" id="imgCamera4" class="webcam4" src="http://trafficcam-fetcher.savina.net/serve_single_pic/<?php echo $webcam;?>/4">
<img alt="!" id="imgCamera3" class="webcam3" src="http://trafficcam-fetcher.savina.net/serve_single_pic/<?php echo $webcam;?>/3"> 
<img alt="!" id="imgCamera2" class="webcam2" src="http://trafficcam-fetcher.savina.net/serve_single_pic/<?php echo $webcam;?>/2"> 
<img alt="!" id="imgCamera1" class="webcam1" src="http://trafficcam-fetcher.savina.net/serve_single_pic/<?php echo $webcam;?>/1">
<img alt="!" id="imgCamera0" class="webcam0" src="http://trafficcam-fetcher.savina.net/serve_single_pic/<?php echo $webcam;?>/0">-->
<a href="#right"><img alt="!" id="now" class="now" src="images/now.png"></a>
